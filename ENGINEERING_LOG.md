...
* **The Strategic Metric Selection:** I architected the app around only three core pillars:
  1. **Calories:** The non-negotiable metric for basic thermodynamic weight management.
  2. **Protein:** The critical building block for muscle preservation, recovery, and maintaining high satiety.
  3. **Fibre:** The highly underrated "health" macro. By explicitly tracking Fibre instead of generic carbohydrates, the app subtly influences users toward whole foods, promoting gut health and stable blood glucose, without the stress of micro-managing complex carb ratios.
...
1. **Forced "First Open" Login vs. Deferred Auth:**
...
2. **The "Quick-Add" Widget:** * *Original Idea:* Build an Android home-screen widget for fast, repetitive entries (e.g., "Black Coffee").
...
4. **Security & Rate Limiting (Defense in Depth):**
